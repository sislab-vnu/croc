...
`elsif TARGET_GF180MCU
    ...
    gf180mcu_fd_io__bi_t   pad_jtag_tdo_o   (.PAD(jtag_tdo_o),   .A(soc_jtag_tdo_o), .CS(1'b0),
    ...
    gf180mcu_fd_io__bi_t   pad_uart_tx_o    (.PAD(uart_tx_o),    .A(soc_uart_tx_o), .OE(1'b1),
					       .CS(1'b0), .SL(1'b0), .IE(1'b0), .PU(1'b1), .PD(1'b0), .Y());

    gf180mcu_fd_io__in_c  pad_fetch_en_i   (.PAD(fetch_en_i),   .Y(soc_fetch_en_i));
    gf180mcu_fd_io__bi_t pad_status_o     (.PAD(status_o),     .A(soc_status_o), .OE(1'b1),
 ...
 `define OUTPUT_PAD (id, pad, c2p) \
   gf180mcu_fd_io__bi_t pad_gpio_``id``     (.PAD(pad), .A(c2p), .Y() .OE(1'b1), \
					    .CS(1'b0), .SL(1'b0), .IE(1'b0), .PU(1'b0), \
					    .PD(1'b1));

   gf180mcu_fd_io__bi_t pad_gpio0_io (.PAD(gpio0_io), .A(soc_gpio_o[0]), .Y(soc_gpio_i[0]), .OE(soc_gpio_out_en_o[0]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[0]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio1_io (.PAD(gpio1_io), .A(soc_gpio_o[1]), .Y(soc_gpio_i[1]), .OE(soc_gpio_out_en_o[1]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[1]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio2_io (.PAD(gpio2_io), .A(soc_gpio_o[2]), .Y(soc_gpio_i[2]), .OE(soc_gpio_out_en_o[2]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[2]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio3_io (.PAD(gpio3_io), .A(soc_gpio_o[3]), .Y(soc_gpio_i[3]), .OE(soc_gpio_out_en_o[3]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[3]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio4_io (.PAD(gpio4_io), .A(soc_gpio_o[4]), .Y(soc_gpio_i[4]), .OE(soc_gpio_out_en_o[4]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[4]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio5_io (.PAD(gpio5_io), .A(soc_gpio_o[5]), .Y(soc_gpio_i[5]), .OE(soc_gpio_out_en_o[5]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[5]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio6_io (.PAD(gpio6_io), .A(soc_gpio_o[6]), .Y(soc_gpio_i[6]), .OE(soc_gpio_out_en_o[6]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[6]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio7_io (.PAD(gpio7_io), .A(soc_gpio_o[7]), .Y(soc_gpio_i[7]), .OE(soc_gpio_out_en_o[7]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[7]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio8_io (.PAD(gpio8_io), .A(soc_gpio_o[8]), .Y(soc_gpio_i[8]), .OE(soc_gpio_out_en_o[8]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[8]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio9_io (.PAD(gpio9_io), .A(soc_gpio_o[9]), .Y(soc_gpio_i[9]), .OE(soc_gpio_out_en_o[9]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[9]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio10_io (.PAD(gpio10_io), .A(soc_gpio_o[10]), .Y(soc_gpio_i[10]), .OE(soc_gpio_out_en_o[10]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[10]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio11_io (.PAD(gpio11_io), .A(soc_gpio_o[11]), .Y(soc_gpio_i[11]), .OE(soc_gpio_out_en_o[11]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[11]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio12_io (.PAD(gpio12_io), .A(soc_gpio_o[12]), .Y(soc_gpio_i[12]), .OE(soc_gpio_out_en_o[12]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[12]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio13_io (.PAD(gpio13_io), .A(soc_gpio_o[13]), .Y(soc_gpio_i[13]), .OE(soc_gpio_out_en_o[13]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[13]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio14_io (.PAD(gpio14_io), .A(soc_gpio_o[14]), .Y(soc_gpio_i[14]), .OE(soc_gpio_out_en_o[14]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[14]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio15_io (.PAD(gpio15_io), .A(soc_gpio_o[15]), .Y(soc_gpio_i[15]), .OE(soc_gpio_out_en_o[15]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[15]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio16_io (.PAD(gpio16_io), .A(soc_gpio_o[16]), .Y(soc_gpio_i[16]), .OE(soc_gpio_out_en_o[16]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[16]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio17_io (.PAD(gpio17_io), .A(soc_gpio_o[17]), .Y(soc_gpio_i[17]), .OE(soc_gpio_out_en_o[17]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[17]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio18_io (.PAD(gpio18_io), .A(soc_gpio_o[18]), .Y(soc_gpio_i[18]), .OE(soc_gpio_out_en_o[18]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[18]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio19_io (.PAD(gpio19_io), .A(soc_gpio_o[19]), .Y(soc_gpio_i[19]), .OE(soc_gpio_out_en_o[19]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[19]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio20_io (.PAD(gpio20_io), .A(soc_gpio_o[20]), .Y(soc_gpio_i[20]), .OE(soc_gpio_out_en_o[20]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[20]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio21_io (.PAD(gpio21_io), .A(soc_gpio_o[21]), .Y(soc_gpio_i[21]), .OE(soc_gpio_out_en_o[21]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[21]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio22_io (.PAD(gpio22_io), .A(soc_gpio_o[22]), .Y(soc_gpio_i[22]), .OE(soc_gpio_out_en_o[22]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[22]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio23_io (.PAD(gpio23_io), .A(soc_gpio_o[23]), .Y(soc_gpio_i[23]), .OE(soc_gpio_out_en_o[23]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[23]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio24_io (.PAD(gpio24_io), .A(soc_gpio_o[24]), .Y(soc_gpio_i[24]), .OE(soc_gpio_out_en_o[24]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[24]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio25_io (.PAD(gpio25_io), .A(soc_gpio_o[25]), .Y(soc_gpio_i[25]), .OE(soc_gpio_out_en_o[25]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[25]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio26_io (.PAD(gpio26_io), .A(soc_gpio_o[26]), .Y(soc_gpio_i[26]), .OE(soc_gpio_out_en_o[26]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[26]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio27_io (.PAD(gpio27_io), .A(soc_gpio_o[27]), .Y(soc_gpio_i[27]), .OE(soc_gpio_out_en_o[27]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[27]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio28_io (.PAD(gpio28_io), .A(soc_gpio_o[28]), .Y(soc_gpio_i[28]), .OE(soc_gpio_out_en_o[28]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[28]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio29_io (.PAD(gpio29_io), .A(soc_gpio_o[29]), .Y(soc_gpio_i[29]), .OE(soc_gpio_out_en_o[29]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[29]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio30_io (.PAD(gpio30_io), .A(soc_gpio_o[30]), .Y(soc_gpio_i[30]), .OE(soc_gpio_out_en_o[30]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[30]), .PU(1'b0), 
					    .PD(1'b1));
    

   gf180mcu_fd_io__bi_t pad_gpio31_io (.PAD(gpio31_io), .A(soc_gpio_o[31]), .Y(soc_gpio_i[31]), .OE(soc_gpio_out_en_o[31]), 
					    .CS(1'b0), .SL(1'b0), .IE(~soc_gpio_out_en_o[31]), .PU(1'b0), 
					    .PD(1'b1));
    
   (* dont_touch = "true" *)
   gf180mcu_fd_io__bi_t pad_unused0_o (.PAD(unused0_o), .A(soc_status_o),
					 .Y(), .OE(1'b1),
					 .CS(1'b0), .SL(1'b0), .IE(1'b0), .PU(1'b0),
					 .PD(1'b1));
   (* dont_touch = "true" *)
   gf180mcu_fd_io__bi_t pad_unused1_o (.PAD(unused0_o), .A(soc_status_o),
					 .Y(), .OE(1'b1),
					 .CS(1'b0), .SL(1'b0), .IE(1'b0), .PU(1'b0),
					 .PD(1'b1));
   (* dont_touch = "true" *)
   gf180mcu_fd_io__bi_t pad_unused2_o (.PAD(unused0_o), .A(soc_status_o),
					 .Y(), .OE(1'b1),
					 .CS(1'b0), .SL(1'b0), .IE(1'b0), .PU(1'b0),
					 .PD(1'b1));
   (* dont_touch = "true" *)
   gf180mcu_fd_io__bi_t pad_unused3_o (.PAD(unused0_o), .A(soc_status_o),
					 .Y(), .OE(1'b1),
					 .CS(1'b0), .SL(1'b0), .IE(1'b0), .PU(1'b0),
					 .PD(1'b1));
