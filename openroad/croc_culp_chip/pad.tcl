...
# place_pad -row IO_NORTH  -location [expr $start -  2*$pitch] "pad_gpio11_io"       ; # pin no:  3
# place_pad -row IO_NORTH  -location [expr $start -  3*$pitch] "pad_gpio10_io"       ; # pin no:  4
# place_pad -row IO_NORTH  -location [expr $start -  4*$pitch] "pad_gpio9_io"       ; # pin no:  5
# place_pad -row IO_NORTH  -location [expr $start -  5*$pitch] "pad_gpio8_io"       ; # pin no:  6
# place_pad -row IO_NORTH  -location [expr $start -  6*$pitch] "pad_gpio7_io"       ; # pin no:  7
# place_pad -row IO_NORTH  -location [expr $start -  7*$pitch] "pad_gpio6_io"       ; # pin no:  8
# place_pad -row IO_NORTH  -location [expr $start -  8*$pitch] "pad_gpio5_io"       ; # pin no:  9
# place_pad -row IO_NORTH  -location [expr $start -  9*$pitch] "pad_gpio4_io"       ; # pin no: 10
