...
add_pdn_stripe -grid {block} -layer {Metal1} -width {0.600} -pitch {5.040} -offset {0} \
  -followpins -snap_to_grid
add_pdn_stripe -grid {block} -layer {Metal4} -width {4.480} -spacing {0.56} -pitch {44.8} \
  -offset {22.4} -snap_to_grid
