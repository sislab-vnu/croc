...
set CROC            i_croc_soc/i_croc_soc/i_croc
set USER            i_croc_soc/i_croc_soc/i_user
...
set_driving_cell [all_inputs] -lib_cell gf180mcu_fd_io__in_c -pin PAD
...
set_output_delay -min -add_delay -clock clk_sys [ expr $TCK_SYS * 0.10 ] [get_ports {status_o gpio* pll_clk_o}]
set_output_delay -max -add_delay -clock clk_sys [ expr $TCK_SYS * 0.30 ] [get_ports {status_o gpio* pll_clk_o}]

set_input_delay  -min -add_delay -clock clk_sys [ expr $TCK_SYS * 0.10 ] [get_ports {osc_clk_i}]
set_input_delay  -max -add_delay -clock clk_sys [ expr $TCK_SYS * 0.30 ] [get_ports {osc_clk_i}]
