...
source scripts/init_tech_${TECHNO}.tcl
utl::report "Finish init tech"
...
read_sdc src/constraints_${TECHNO}.sdc
...
source scripts/power_connect_${TECHNO}.tcl

utl::report "Create Floorplan"
source scripts/floorplan_${TECHNO}.tcl

utl::report "Create Power Grid"
source scripts/power_grid_${TECHNO}.tcl
