...
proc sram_power { name macro } {
    ...
    add_pdn_connect -grid ${name}_grid -layers {Metal5 Metal3}
...
sram_power "sram_256x64"  "gf180mcu_fd_ip_sram__sram512x8m8wm1"

# Top power grid
# Top 2 Stripe
add_pdn_stripe -grid {core_grid} -layer {Metal5} -width $tpg2Width \
...
add_pdn_connect -grid {core_grid} -layers {Metal5 Metal1}
add_pdn_connect -grid {core_grid} -layers {Metal5 Metal2}
add_pdn_connect -grid {core_grid} -layers {Metal5 Metal4}
